...
{
    //Valmiiksi annettu koodi, jossa simuloidaan datalähdettä
    public static class Data
    {
        ...
        private static string GenerateFirstName()
        {
            string[] names =
                ...
                "Iines","Ilkka","Ilmari","Ida","Irene","Jaakko","Jari","Juha","Jukka","Jaana","Juhani","Kalevi","Kikka","Kaarina",
                "Kalle","Kauko","Kimmo", "Liisa","Leevi","Lilli","Lumi","Martti","Matti","Mauno","Melina","Miisa","Merja","Marja",
                "Niilo","Nina","Niina","Ninna","Oona","Olavi","Oskari","Pentti","Panu","Pertti","Petri","Paula","Pauliina","Pirkko",
                "Raimo","Rauli","Riikka","Ritva","Raili","Sara", "Saara", "Sauli","Sakari","Seppo","Taina","Tiina","Tuuli","Tuula","Timo",
        ...
        {
            string[] part1 = 
                {"Aalto", "Joki", "Meri", "Järvi", "Virta", "Vuori", "Lehto",
